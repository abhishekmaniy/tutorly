...
"
    >
      ...
      <BackgroundLines className="relative overflow-hidden py-20 lg:py-32">
        <div className="absolute right-6 top-6 z-30 flex">
           <a
            href="https://peerlist.io/abhishek3811/project/tutorly"
            target="_blank"
            rel="noreferrer"
          >
            <img
              src="https://peerlist.io/api/v1/projects/embed/PRJHGNLD6BODG6BLOHD7EDJMNE8OA8?showUpvote=true&theme=dark"
              alt="Tutorly"
            ...
            <Card className="p-8">
              ...
              >
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/Lod_xejK0a0?si=eFkUI6GUN6FXgITL"
