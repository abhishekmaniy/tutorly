...
import { BookOpen, Brain, CheckCircle, Zap, Star, ArrowRight, Sparkles, Target, TrendingUp } from "lucide-react"
...
export function LandingPage() {
  ...
  const pricing = [
    {
      ...
      features: ["5 AI-generated courses per month", "Basic progress tracking", "Standard quiz types", "Email support"],
      popular: false,
    },
    {
      name: "Pro",
  ...
  const reviews = [
    ...
    },
    {
      ...
      content: "I've completed 12 courses so far. The platform makes learning addictive in the best way possible!",
      rating: 5,
      avatar: "/placeholder.svg?height=40&width=40",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-muted-foreground sm:text-2xl">
              Transform any topic into a comprehensive learning experience. Just describe what you want to learn, and
              let our AI create the perfect course for you.
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Powerful Features for Modern Learning</h2>
            <p className="text-lg text-muted-foreground">
              Everything you need to create, learn, and track your educational journey
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">See How It Works</h2>
            <p className="text-lg text-muted-foreground">
              Experience the power of AI-driven learning through our intuitive interface
            </p>
          </div>
            ...
            <Card className="p-8">
              <div className="aspect-video rounded-lg bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Platform Screenshots</h3>
                  <p className="text-muted-foreground">Screenshots will be added here to showcase the platform</p>
                </div>
              </div>
            </Card>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Choose Your Learning Plan</h2>
            <p className="text-lg text-muted-foreground">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center mb-16">
            <h2 className="mb-4 text-3xl font-bold sm:text-4xl">What Our Learners Say</h2>
            <p className="text-lg text-muted-foreground">
              Join thousands of satisfied learners who've transformed their skills with Tutorly
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <Card className="gradient-bg text-white">
            <CardContent className="p-12 text-center">
              <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Ready to Start Learning?</h2>
              <p className="mb-8 text-xl opacity-90">
                Join thousands of learners and start your AI-powered education journey today.
              </p>
              <Link href="/prompt">
      ...
      <footer className="border-t py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <p className="text-muted-foreground">© 2024 Tutorly. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
